...
export const metadata: Metadata = {
  title: 'Ivan Sheihys | Portfolio',
  description:
    'Check out modern and stylish porfolio of an experienced Web Developer Ivan Sheihys! Built using TypeScript, Next.js 14, Framaer Motion and Tailwind CSS.',
};
